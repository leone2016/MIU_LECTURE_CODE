...
public class Main {
	...
	public static void main(String[] args) {
		...
		// ShoppingCart.computeBaseCost(itemsForGoldCart);
		ShoppingCart ordinaryCart = new ShoppingCartOrdinary("Joe Ordinary", itemsForOrdinaryCart,
				LocalDate.of(2017, 8, 2));

		// Gold members get a fixed discount
		ShoppingCart goldCart = new ShoppingCartGoldMember("Jim Special", itemsForGoldCart, LocalDate.of(2017, 8, 2),
				.05);
